...
def build_system_prompt() -> str:
    ...
    return (
        ...
        "source (PDF excerpts are labeled with the file name and page, e.g. [filename.pdf p.12]; "
        "other types: [Video 3:22], [Slide 3], [Web: Title]).\n"
        ...
        "- Cite the source label(s) for facts you used, inline, e.g. "
        "(intro-to-statistical-learning.pdf p.12) or (Slide 3). "
        "Reproduce the label exactly as shown in CONTEXT so it can be linked.\n\n"
